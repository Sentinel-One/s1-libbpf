 ...
 *
 * This function configures the prog_type
 * used by *probe_* functions.
 *
 ...
 *
 */
LIBBPF_API bool libbpf_probe_set_prog_type(enum bpf_prog_type type);

// Customization:
/*
 *  if 'libbpf_probe_set_prog_type' was called before,
 *  this function will return the configured type,
